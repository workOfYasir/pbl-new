...
<li class="nav-item">
<a class="nav-link active" data-toggle="tab" href="#home7" role="tab"><i class="icofont icofont-home"></i>Create Group (Individual) </a>
<div class="slide"></div>
</li>
<li class="nav-item">
<a class="nav-link" data-toggle="tab" href="#profile7" role="tab"><i class="icofont icofont-ui-user "></i>Create Group  (Multiple)</a>
<div class="slide"></div>
</li>
...
<div class="col-sm-4">
<input type="number" min="1" class="form-control" name="group_no"  id="group_no" placeholder="Enter group no">
</div>
</div>
<div class="form-group row">
<label class="col-sm-2 col-form-label">Project title </label>
<div class="col-sm-10">
<input type="text" class="form-control" name="title" id="title" placeholder="Enter project tile">
</div>
</div>
 
<div class="form-group row">
<label class="col-sm-2 col-form-label">Attach proposal</label>
<div class="col-sm-10">
...
<div class="form-group row">
<label class="col-sm-2 col-form-label">Project members </label>
<div class="col-sm-3">
<input type="text" class="form-control" name="member_one" id="memeber_1" placeholder="Enter Memeber 1 Roll no">
</div>
...
<div class="col-sm-3">
<input type="text" class="form-control" name="memeber_2" id="memeber_2" placeholder="Enter Memeber 2 Roll no">
</div>
...
<div class="col-sm-3">
<input type="text" class="form-control" name="memeber_3" id="memeber_3" placeholder="Enter Memeber 3 Roll no">
</div>
...
<input type="text" style="padding:5px;font-size:16px;width:30px;" placeholder="19" required>
...
<form  action="saveMgroups.php" method="post"  enctype="multipart/form-data"  >
<div class="form-group row">
<label class="col-sm-2 col-form-label">Upload Groups</label>
<div class="col-sm-10">
...
<select name="session"  id="fall"    onchange="getcourses()" style="margin-left:16px;width:150px;padding-left:10px;" required>
<option value="">Select Session</option>
...
<label class="col-sm-2 col-form-label">Courses</label>
<div class="col-sm-10">
<select name="courses" class="form-control" onchange="getsection()"  id="course" required>
...
<select name="sec" class="form-control" id="section" required>
...
<div class="form-group row">
<label class="col-sm-2 col-form-label">Create Groups</label>
<div class="col-sm-10">
<button name="submit" class="btn btn-primary" id="submit" type="submit">Save</button>
</div>
</div>
