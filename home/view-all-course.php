...
<li class="nav-item">
<a class="nav-link active" data-toggle="tab" href="#profile7" role="tab"><i class="icofont icofont-ui-user "></i>View All Courses</a>
<div class="slide"></div>
</li>
...
<a href="edit-course?course='.$row['c_id'].'" class="m-r-15 text-muted" data-toggle="tooltip" data-placement="top" title="Edit" data-original-title="Edit"><i class="icofont icofont-ui-edit"></i></a>
<a href="#"  onclick="delete_course('.$row['c_id'].')" class="text-muted" data-toggle="tooltip" data-placement="top" title="Delete" data-original-title="Delete"><i class="icofont icofont-delete-alt"></i>
</a>
</td>';
...
function delete_course(id)
{
	...
	swal({
  title: "Are you sure?",
  text: "Once deleted, Student Will Not be able to Enroll This!",
  icon: "warning",
  buttons: true,
  dangerMode: true,
})
.then((willDelete) => {
  if (willDelete) {
    swal("! Your Selected Course has been deleted!", {
      icon: "success",
    });
	
	window.location="delete-single-course?course="+id;
	
  } else {
    swal("Your Selected Course is safe!");
  }
});
}
