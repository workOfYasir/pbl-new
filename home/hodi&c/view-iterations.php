...
<center> <a href="add-new-iteration.php?course='.$row['c_id'].'" class="text-muted" data-toggle="tooltip"  data-placement="top" title="Manage Iterations " data-original-title="Manage Iterations"><i class="icofont icofont-automation"></i>
</a></center>
</td>';
