...
<a href="edit-department?department='.$row['dept_id'].'"  class="m-r-15 text-muted" data-toggle="tooltip" data-placement="top" title="Edit" data-original-title="Edit"><i  style="color:blue;" class="icofont icofont-ui-edit"></i></a>
<a href="#!" onclick="delete_dept('.$row['dept_id'].')"   class="text-muted" data-toggle="tooltip" data-placement="top" title="delete" data-original-title="Delete"><i style="color:red;" class="icofont icofont-delete-alt"></i>
</a>
</td>';
...
function delete_dept(id)
{
	...
	swal({
  title: "Are you sure?",
  text: "Once deleted, You Can not Manage It!",
  icon: "warning",
  buttons: true,
  dangerMode: true,
})
.then((willDelete) => {
  if (willDelete) {
    swal("! Your Selected Department has been Trashed!", {
      icon: "success",
    });
	
	window.location="delete-single-department?department="+id;
	
  } else {
    swal("Your Selected Department is safe!");
  }
});
}
