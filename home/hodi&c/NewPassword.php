...
if ($_SERVER["REQUEST_METHOD"] == "POST") 
{
	...
	if(strcmp($pass,$pass2)==0)
	{
	 ...
	 $q = " UPDATE users SET u_password='$pass'  WHERE  u_idno='$userRoll' ";
 	if ($conn->query($q) === TRUE) {
			echo " <script type='text/javascript'>

      if(window.confirm('Successfully Change Password!!)'))
      {
...
else
{
	...
	echo " <script type='text/javascript'>
      ...
      if(window.confirm('In Correct Password Please Enter Same Password in Both Fields!!)'))
      {
...
<input autocomplete="off" type="password"  name="change" class="form-control" placeholder="Enter New Password" required>
<span class="md-line"></span>
</div>
<div class="input-group">
<input autocomplete="off" type="password"  name="change2" class="form-control" placeholder="Confirm New Password" required>
<span class="md-line"></span>
</div>
<div class="row">
<div class="col-md-12">
