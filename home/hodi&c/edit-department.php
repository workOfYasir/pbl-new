...
<li class="nav-item">
<a class="nav-link active" data-toggle="tab" href="#home7" role="tab"><i class="icofont icofont-home"></i>Edit Department </a>
<div class="slide"></div>
</li>
...
<form action="saveEditDept?department=<?php echo $department;?>" autocomplete="off" method="post" class="j-pro" id="j-pro" enctype="multipart/form-data" novalidate  >
...
<input  autocomplete="off" type="text" value="<?php echo $row['dept_name']; ?>" id="first_name" name="name" placeholder="Department Name" required/>
 </div>
</div>
<div class="j-span6 j-unit">
<div class="j-input">
...
<input  autocomplete="off" type="text" value="<?php echo $row['dept_code']; ?>" id="last_name" name="code" placeholder="Degree Code" required/>
</div>
</div>
</div>
