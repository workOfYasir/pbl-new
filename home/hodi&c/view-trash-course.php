...
<li class="nav-item">
<a class="nav-link active" data-toggle="tab" href="#profile7" role="tab"><i class="icofont icofont-recycling-man "></i>View All trash Courses</a>
<div class="slide"></div>
</li>
...
include 'connection.php';
$sql = "SELECT * FROM course where is_dell='yes'";
...
if ($result->num_rows > 0) {
 ...
 <a href="#"  onclick="delete_course('.$row['c_id'].')" class="text-muted" data-toggle="tooltip" data-placement="top" title="Recover" data-original-title="Recover"><i class="icofont icofont-reply"></i>
</a>
</td>';
...
function delete_course(id)
{
	...
	swal({
  title: "Are you sure?",
  text: "Once Recover, Student Will   be able to Enroll This!",
  icon: "info",
  buttons: true,
  dangerMode: false,
})
.then((willDelete) => {
  if (willDelete) {
    swal("! Your Selected Course has been Recovered!", {
      icon: "success",
    });
	
	window.location="recover-single-course?course="+id;
