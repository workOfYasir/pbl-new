...
<li class="nav-item">
<a class="nav-link" data-toggle="tab" href="#profile7" role="tab"><i class="icofont icofont-ui-user "></i>Add teacher (Multiple)</a>
<div class="slide"></div>
</li>
<li class="nav-item">
<a class="nav-link" data-toggle="tab" href="#messages7" role="tab"><i class="icofont icofont-ui-message"></i>View All teacher</a>
<div class="slide"></div>
</li>
...
<form  autocomplete="off" action="saveTeacher.php" method="post" class="j-pro" id="j-pro" enctype="multipart/form-data" novalidate  >
...
<input type="text" id="Teacher_name" name="Teacher_name" placeholder="Enter Teacher name">
 </div>
</div>
<div class="j-span6 j-unit">
<div class="j-input">
