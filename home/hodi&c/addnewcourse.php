...
<li class="nav-item">
<a class="nav-link active" data-toggle="tab" href="#home7" role="tab"><i class="icofont icofont-home"></i>Add New Course   </a>
<div class="slide"></div>
</li>
<li class="nav-item">
<a class="nav-link" data-toggle="tab" href="#profile7" role="tab"><i class="icofont icofont-ui-user "></i>View All Courses</a>
<div class="slide"></div>
</li>
...
<form action="saveCourse.php" method="post" class="j-pro" id="j-pro" enctype="multipart/form-data" novalidate  >
...
<input autocomplete="off" type="text" id="first_name" name="name" placeholder="Course Name">
 </div>
</div>
<div class="j-span6 j-unit">
<div class="j-input">
...
<input autocomplete="off" type="text" id="last_name" name="level" placeholder="Level">
</div>
</div>
</div>
...
<input autocomplete="off" type="text" id="first_name" name="min" placeholder="Minimum Group Members">
 </div>
</div>
<div class="j-span6 j-unit">
<div class="j-input">
...
<input autocomplete="off" type="text" id="last_name" name="max" placeholder="Maximum Group Members">
</div>
</div>
</div>
...
<th>Course Name</th>
<th>level</th>
<th>Maximum Students In Group</th>
<th>Minimum Students In Group</th>
<th>Operation</th>
