...
<head>
<title>PBL | <?php echo $userType; ?>Ruberics</title>
...
<form action="saveRuberics.php" method="POST" enctype="multipart/form-data" >
Ruberic Question:
...
<li class="breadcrumb-item"><a href="#">Manage Ruberics</a>
</li>
</ul>
</div>
</div>
...
<h5>Project Exhibition  Ruberics list</h5>
...
<a href="edit-ruberic.php?ruberics='.$row['r_id'].'">  <button type="button" class="btn btn-info     btn-mini  "    >
 <i class="icofont icofont-ui-edit"></i>Edit  </button>  </a>
 &nbsp;
 
<a href="drop-ruberics.php?ruberics='.$row['r_id'].'"> <button type="button" class="btn btn-danger     btn-mini  "    >
