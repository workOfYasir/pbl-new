...
$sql = "SELECT * FROM teacher where t_id='$teacher'";
...
<form  autocomplete="off" action="save-edit-teacher?teacher=<?php echo $teacher; ?>" method="post" class="j-pro" id="j-pro" enctype="multipart/form-data" novalidate  >
...
<input type="text" id="Teacher_name" value="<?php echo $row['t_name']; ?>" name="Teacher_name" placeholder="Enter Teacher name" required/>
 </div>
</div>
<div class="j-span6 j-unit">
<div class="j-input">
