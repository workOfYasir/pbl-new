...
<!-- Mirrored from html.codedthemes.com/mash-able/light/dt-ext-responsive.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 19 Sep 2019 14:13:04 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
<title>Students | PBL</title>
...
<h4>Record Of All Students</h4>
<span>Can Select Filtered Students</span>
</div>
...
<li class="breadcrumb-item"><a href="#!">Manage Students</a>
</li>
<li class="breadcrumb-item"><a href="#!">View All Student</a>
</li>
</ul>
</div>
</div>
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc())
     {
		...
		$sqll = "SELECT * FROM student where s_roll = '$roll'";
 ...
 echo "<td>".$roww['s_name']."</td>";
	...
	echo "<td><a  ><button type='button' class='btn btn-warning'>Edit</button> </a> 
