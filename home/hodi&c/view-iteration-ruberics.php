                                            ...
                                            <div class="tab-content modal-body">
                                                <div class="tab-pane active" id="tab-home" role="tabpanel">
                                                    ...
                                                    <form action="saveIterationRuberics.php" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        Ruberics
                                                        <input type="text" name="rub1" id="rub1" placeholder="ruberics 1">
                                                        <input type="text" name="rub2" id="rub2" placeholder="ruberics 2">
                                                        <input type="text" name="rub3" id="rub3" placeholder="ruberics 3">
                                                        <input type="text" name="rub4" id="rub4" placeholder="ruberics 4">
                                                        <input type="text" name="rub5" id="rub5" placeholder="ruberics 5">
                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-header">
                                        <div class="page-header-title">
                                            <h4>Ruberics | Ruberics list &nbsp;&nbsp;&nbsp;
                                                <button type="button" class="btn btn-success   float-right btn-mini " data-toggle="modal" data-target="#Modal-tab">Add New Ruberic</button>
                                            </h4>
                                        </div>
                                                        ...
                                                        <div>
                                                            <table id="simpletable" class="table dt-responsive task-list-table table-striped table-bordered nowrap">
                                                                ...
                                                                <tbody class="task-page">
                                                                    ...
                                                                    $course = $_GET['course'];
                                                                    $iteration_id = $_GET['iteration'];

                                                                    $sql = "SELECT  * FROM  iterations_ruberics  where course_id='$course'  and iteration_id='$iteration_id'";
...
<td>' . $row['points'] . '</td>
<td>' . $row['weight'] . '%</td>
<td>'.$row['rub1'].' , ',$row['rub2'],' , '.$row['rub3'].' , '.$row['rub4'].' , '.$row['rub5'].'</td>
 
 
<td>

 
<a href="edit-iteration-ruberic.php?ruberics=' . $row['r_id'] . '&course=' . $_GET['course'] . '&iteration=' . $_GET['iteration'] . '">  <button type="button" class="btn btn-info     btn-mini  "    >
 <i class="icofont icofont-ui-edit"></i>Edit  </button>  </a>
 &nbsp;
 
<a href="drop-iteration-ruberics.php?ruberics=' . $row['r_id'] . '&course=' . $_GET['course'] . '&iteration=' . $_GET['iteration'] . '"> <button type="button" class="btn btn-danger     btn-mini  "    >
 <i class="icofont icofont-ui-delete"></i>Drop  </button> 
  </a>
                                                                        ...
                                                                        echo "<tr>
	 <td colspan='5'><center style='color:orange;'>No Ruberics Added Yet!</center>
	 <td><tr>";
                                                                    }
                                                                    ?>
