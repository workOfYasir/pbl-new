...
<head>
<title>PBL |   Iteration Ruberics</title>
...
<h4>Ruberics | Ruberics list &nbsp;&nbsp;&nbsp;
 <button type="button" class="btn btn-success   float-right btn-mini " data-toggle="modal" data-target="#Modal-tab">Add New Ruberic</button></h4>
</div>
