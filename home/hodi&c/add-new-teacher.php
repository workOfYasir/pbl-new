                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12 col-xl-12">
                                                                ...
                                                                <ul class="nav nav-tabs md-tabs " role="tablist">
                                                                    <li class="nav-item">
                                                                        <a class="nav-link active" data-toggle="tab" href="#home7" role="tab"><i class="icofont icofont-home"></i>Add HOD </a>
                                                                        <div class="slide"></div>
                                                                    </li>
                                                                ...
                                                                <div class="tab-content card-block">
                                                                    ...
                                                                    <div class="tab-pane active" id="home7" role="tabpanel">
                                                                        ...
                                                                        <form action="saveTeacher" autocomplete="off" method="post" enctype="multipart/form-data">
