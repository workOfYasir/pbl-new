...
<head>
<title>PBL | <?php echo $userType; ?>Courses</title>
...
$sql = "SELECT * FROM course where c_id='$course'";
...
<li class="nav-item">
<a class="nav-link active" data-toggle="tab" href="#home7" role="tab"><i class="icofont icofont-home"></i>Edit  Course   </a>
<div class="slide"></div>
</li>
...
<form action="save-edit-course?course=<?php echo $course;?>" method="POST" class="j-pro" id="j-pro"     >
...
<input autocomplete="off" type="text" value="<?php echo $row['c_name']; ?>"  id="first_name" name="name" placeholder="Course Name" required/>
 </div>
</div>
<div class="j-span6 j-unit">
<div class="j-input">
...
<input autocomplete="off" pattern="[0-9]*" value="<?php echo $row['c_level']; ?>" type="text" id="last_name" name="level" placeholder="Level" required/>
</div>
</div>
</div>
...
<div class="j-input">
<label class="j-icon-right" for="first_name">
<i class="icofont icofont-battery-low"></i>
</label>
<input autocomplete="off"  pattern="[0-9]*"  value="<?php echo $row['c_min']; ?>" type="text" id="first_name" name="min" placeholder="Minimum Group Members" required/> 
 </div>
</div>
<div class="j-span6 j-unit">
<div class="j-input">
<label class="j-icon-right" for="last_name">
<i class="icofont icofont-battery-half"></i>
</label>
<input autocomplete="off"  pattern="[0-9]*" value="<?php echo $row['c_max']; ?>" type="text" id="last_name" name="max" placeholder="Maximum Group Members"  required/>
</div>
</div>
</div>
