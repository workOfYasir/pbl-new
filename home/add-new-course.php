...
<input autocomplete="off"  pattern="[0-9]*"   type="text" id="first_name" name="min" placeholder="Minimum Group Members" required/> 
 </div>
</div>
<div class="j-span6 j-unit">
<div class="j-input">
...
<input autocomplete="off"  pattern="[0-9]*" type="text" id="last_name" name="max" placeholder="Maximum Group Members"  required/>
</div>
</div>
</div>
